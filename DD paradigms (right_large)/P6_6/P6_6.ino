 /*--------------------------------------------------------++
||    DD_P6_2 (both lights on + large reward + with FC)    ||
++--------------------------------------------------------*/
...
String paradigm = "DD_P6_6_rl_vf";  // rl = right large (right port is the large reward port)
...
void loop() {
    ...
    else if (current_port > 2) { //a standard P6 trial with both ports on 
      // delay(1);
      activate_middle_led();
      activate_middle_sol();
      } 
