...
const int trial_delay_duration = 1;     // used to introduce a delay before the trial window; 1ms (practially 0 ms) for this paradigm; can be increased to add a delay in other experiments 
const int reward_delay_duration = 2000; //2 sec delay before large reward is dispensed 
...
int i = 1; //controls how many drops of reward will be dispensed 
// * * * * * NOT USED * * * * *
