...
void activate_middle_led() {
	...
	//MY ADDITION HERE: EDITS THE SOL ON DURATION TO MODIFY REWARD AMOUNT BASED ON WHICH PORT IS POKED	(L = large reward)
		   solenoid_on_duration = 216;
