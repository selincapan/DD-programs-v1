...
// separate the following windows (into L/R) because they are independent(?) events
// I don't know why, but I feel like I have to separate them into two!

boolean trial_and_hold_window_L;
boolean hold_window_L;
boolean trial_and_hold_window_R;
boolean hold_window_R;

// this boolean indicates when is a VALID event for transitioning to reward dispensal
boolean transition_to_reward;
