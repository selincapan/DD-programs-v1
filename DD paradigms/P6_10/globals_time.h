...
const int reward_delay_duration = 10000; // 10 sec delay before large reward is dispensed (CHANGE HERE AS DELAY INCREASES)

const int reward_cue_duration = 3000;     // change HERE if needed! 
