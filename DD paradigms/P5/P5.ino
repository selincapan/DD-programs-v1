 ...
 * 
 * 10/30/2020 Update: debugged the code + changed m_port_operate to "click" 3 times when giving large reward + updated random_generator (exactly 2/20 trials FC) ==> HAVE TO CHANGE THE EVENT CODES 
 * 
...
String paradigm = "DD_P5_ll_v1"; // ll = left large (left port is the large reward port) 
