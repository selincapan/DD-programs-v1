 ...
 * 
 * 10/29/2020 Update: debugged m_port_operate & finalized the code ==> STILL NEED TO UPDATE THE EVENT CODES!  
 * 
...
String paradigm = "DD_P4_ll_vf";  // ll == left port is the large reward port
...
void setup(){
    ...
    //randomize the trial_type array to randomize order of free choice and forced choice trials 
